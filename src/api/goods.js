...
export const getCartList = (params) => {
  return http.fetchPost('/member/shopcart/list', params)
}
// 加入购物车
export const addCart = (params) => {
  return http.fetchPost('/member/shopcart/add', params)
}
// 删除购物车
...
export const addressList = (params) => {
  console.log(params)
  return http.fetchGet('/member/address/page', params)
}
// 通过id获取地址
...
export const addressUpdate = (params) => {
  return http.fetchPut('/member/address', params)
}
// 添加收货地址
...
export const submitOrder = (params) => {
  return http.fetchPost('/member/order', params)
}
// 支付
...
export const productDet = (params) => {
  return http.fetchGet('/goods/detail', params)
}
// 删除订单
